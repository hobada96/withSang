...
public class BoardTest {
    ...
    public void init() {
        savedBoard = boardRepository.save(Board.builder()
                ...
                .account(accountRepository.save(Account.builder().name("홍길동1").build()))
                .build());
    ...
    @Test
    public void testGetAccountOnBoard() {
        Board findTitleBoard = boardRepository.findFirstByTitle("제목1");
        assertThat(findTitleBoard.getAccount().getName()).isEqualTo("홍길동1");
        assertThat(findTitleBoard.getAccount().getName()).isNotEqualTo("홍길동2");
    }
